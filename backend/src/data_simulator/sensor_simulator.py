...
class SensorSimulator:
    ...
    def _generate_sensor_reading(self, sensor):
        ...
        # Baseline must scale with the same day/night multiplier used for the reading.
        # Otherwise “normal” daytime energy can incorrectly fall into the ENERGY CRITICAL band.
